/**
 * Created by Jian Li on 15/11/15.
 */
...
public class HW4 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //Map <Long ,String> tm =  new HashMap<Long, String>();
        BytesRef bytesRef = null;
        PrintWriter writer = new PrintWriter("termFrequency.txt", "UTF-8");

        while ((bytesRef = te.next()) != null){
            Term uniqueTerm = new Term("contents", te.term());
            long uniqueTermFreq = reader.totalTermFreq(uniqueTerm);
            writer.println(uniqueTerm.text() + " " + uniqueTermFreq);
            //System.out.println(uniqueTerm.text() + " " + uniqueTermFreq);
        }
        writer.close();
